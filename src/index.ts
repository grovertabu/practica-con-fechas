...
let fechaInicio = moment('2022-02-10T04:00:00.000Z'); // '01/02/2023'
let fechaFin = moment('2023-03-10T04:00:00.000Z'); // '30/04/2023'
...
// Itera sobre cada mes y almacena la cantidad de días en el objeto
  ...
  if(dias == 31){
    ...
    daysInMonth[mes] = (30-dias)+1;
  }
  if((typeYear == 366 && mes == 2 && dias == 29) || (typeYear == 365 && mes == 2 && dias == 28)){
    daysInMonth[2] = 30;
  }

  return (daysInMonth[mes]/30).toFixed(1) ;
}
console.log(mesesInYear(2023, 3,21));
